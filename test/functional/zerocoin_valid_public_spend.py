...
from fake_stake.base_test import YarnCoin_FakeStakeTest

class zYARNValidCoinSpendTest(YarnCoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zYARNs..." % DENOM_TO_USE)
