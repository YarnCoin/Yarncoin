...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("YarnCoin Core"),
     ...
     * override -datadir in the yarncoin.conf file in the default data directory
     * (to be consistent with yarncoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
