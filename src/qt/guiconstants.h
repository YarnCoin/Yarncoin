...
/* YarnCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "YarnCoin"
#define QAPP_ORG_DOMAIN "yarncoin.org"
#define QAPP_APP_NAME_DEFAULT "YarnCoin-Qt"
#define QAPP_APP_NAME_TESTNET "YarnCoin-Qt-testnet"
