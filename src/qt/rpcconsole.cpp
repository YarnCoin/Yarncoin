                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzYARNPathCustom = GetArg("-zyarnbackuppath", "");
    ...
    if(!strzYARNPathCustom.empty()) {
        ui->wallet_customzyarnbackuppath->setText(QString::fromStdString(strzYARNPathCustom));
        ui->wallet_customzyarnbackuppath_label->setVisible(true);
        ui->wallet_customzyarnbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzYARNPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the YarnCoin RPC console.") + "<br>" +
