...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::YARN);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeYarnCoinAmount"))
        SoftSetArg("-anonymizeyarncoinamount", settings.value("nAnonymizeYarnCoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in yarncoin.cpp during shotdown to also remove the window positions
