...
/** Utility functions used by the YarnCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render YarnCoin addresses in monospace font
...
// Parse "yarncoin:" URI into recipient object, return true on successful parsing
