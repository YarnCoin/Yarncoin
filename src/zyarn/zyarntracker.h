...
#ifndef YarnCoin_ZYARNTRACKER_H
#define YarnCoin_ZYARNTRACKER_H
...
public:
    CzYARNTracker(std::string strWalletFile);
    ~CzYARNTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzYARNWallet* zYARNWallet = NULL);
