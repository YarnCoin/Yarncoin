...
#ifndef YarnCoin_ZYARNWALLET_H
#define YarnCoin_ZYARNWALLET_H
...
public:
    CzYARNWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZYARN(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZYARN(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
