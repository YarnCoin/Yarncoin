...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop YarnCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "YarnCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* YarnCoin features */
        {"yarncoin", "listmasternodes", &listmasternodes, true, true, false},
        {"yarncoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"yarncoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"yarncoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"yarncoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"yarncoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"yarncoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"yarncoin", "masternodedebug", &masternodedebug, true, true, false},
        {"yarncoin", "startmasternode", &startmasternode, true, true, false},
        {"yarncoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"yarncoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"yarncoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"yarncoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"yarncoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"yarncoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"yarncoin", "preparebudget", &preparebudget, true, true, false},
        {"yarncoin", "submitbudget", &submitbudget, true, true, false},
        {"yarncoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"yarncoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"yarncoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"yarncoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"yarncoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"yarncoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"yarncoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"yarncoin", "checkbudgets", &checkbudgets, true, true, false},
        {"yarncoin", "mnsync", &mnsync, true, true, false},
        {"yarncoin", "spork", &spork, true, true, false},
        {"yarncoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzyarnseed", &getzyarnseed, false, false, true},
        {"zerocoin", "setzyarnseed", &setzyarnseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzyarn", &searchdzyarn, false, false, true},
        {"zerocoin", "dzyarnstate", &dzyarnstate, false, false, true},
...
{
    return "> yarncoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17477/\n";
}
