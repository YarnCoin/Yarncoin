...
/**
 * YarnCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZyarnSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzyarnseed(const UniValue& params, bool fHelp);
extern UniValue getzyarnseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzyarn(const UniValue& params, bool fHelp);
extern UniValue dzyarnstate(const UniValue& params, bool fHelp);
