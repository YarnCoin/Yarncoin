...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("YarnCoin Core yarncoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  yarncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded yarncoin transaction") + "\n" +
                               "  yarncoin-tx [options] -create [commands]   " + _("Create hex-encoded yarncoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded yarncoin transaction
