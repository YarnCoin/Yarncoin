Contributing to YarnCoin Core
============================

The YarnCoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/yarncoin-project/yarncoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the YarnCoin Core project, and is not to be
confused with overall YarnCoin Network Protocol consensus changes.

Whether a pull request is merged into YarnCoin Core rests with the project merge
...
Patches that change YarnCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the YarnCoin consensus, it must have been
...
The project leader is the release manager for each YarnCoin Core release.
