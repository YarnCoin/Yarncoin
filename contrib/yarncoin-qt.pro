...
RESOURCES += src/qt/yarncoin.qrc src/qt/yarncoin_locale.qrc

TRANSLATIONS += src/qt/locale/yarncoin_bg.ts \
                src/qt/locale/yarncoin_de.ts \
                src/qt/locale/yarncoin_en.ts \
                src/qt/locale/yarncoin_es.ts \
                src/qt/locale/yarncoin_fi.ts \
                src/qt/locale/yarncoin_fr.ts \
                src/qt/locale/yarncoin_it.ts \
                src/qt/locale/yarncoin_ja.ts \
                src/qt/locale/yarncoin_pl.ts \
                src/qt/locale/yarncoin_pt.ts \
                src/qt/locale/yarncoin_ru.ts \
                src/qt/locale/yarncoin_sk.ts \
                src/qt/locale/yarncoin_sv.ts \
                src/qt/locale/yarncoin_vi.ts \
                src/qt/locale/yarncoin_zh_CN.ts \
                src/qt/locale/yarncoin_zh_TW.ts
